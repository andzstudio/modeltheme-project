...
class AIToolsCarousel {
    constructor() {
        ...
        this.cards = Array.from(this.track.querySelectorAll('.mt-ai-tools-card'));
        this.btnPrev = document.querySelector('.mt-ai-tools-nav-btn.prev');
        this.btnNext = document.querySelector('.mt-ai-tools-nav-btn.next');
    ...
    updateCarousel() {
        ...
        this.cards.forEach(card => {
            card.className = 'mt-ai-tools-card'; 
        });
